                            ...
                            for idx, img_path in enumerate(dir_file_list):
                                ...
                                for box in nms_boxes:
                                    if box[3] > 4 and box[2] > 4:                                                                           
                                        ...
                                        character_cls1, character_score1, character_boxes1 = dict_yolo_model['OCR'].detect(charimg1, yolo_thresh['OCR'], 0.0)
                                        character_cls2, character_score2, character_boxes2 = dict_yolo_model['OCR'].detect(charimg2, yolo_thresh['OCR'], 0.0)
                                        character_cls3, character_score3, character_boxes3 = dict_yolo_model['OCR'].detect(charimg3, yolo_thresh['OCR'], 0.0)
                                ...
                                if DEBUG:
                                    ...
                                    shutil.move(img_path, output_path+'/'+folder+'/' + split_path)
                                    #shutil.move(img_path, output_path+ '/' + split_path)

                                    text_name = os.path.splitext(split_path)
                                    f = open(output_path+'/'+folder+'/'+text_name[0]+'.txt', 'w', encoding='utf-8')
